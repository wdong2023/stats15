...
For most district, houses with 0 or 1 living room still have relative higher price. Except for ShiJingShan, which has higher mean price for houses with more bedrooms, mainly because ShiJingShan is the smallest district in Beijing. It's more expensive to buy big houses in ShiJingShan. 
...
```{r}
ggplot(data2017, aes(x = followers, y = price)) +
  geom_point() +
  labs(x = "Building Structure", y = "Price", title = "Distribution of Price by Building Structure")
```
