...
### 3.2.2 DOM vs. price
## not sure should keep this or not
*Will the price drops as the house staying longer on the market?*
To test this, we need to first narrow down to houses with similar features. 

```{r}
data2017 %>%
  filter(district=="ChaoYang" & bedRoom==2 & livingRoom==1 & subway=="near_subway" & fiveYearsProperty=="yes" & kitchen==1 & bathRoom==1 & renovationCondition=="simplicity")
...
DongCheng has 41.84 square km and XiCheng has 50.7 square km. XiCheng is indeed greater than DongCheng in areas and might have nore houses on market, but it is not suifficient to explain XiCheng has 2 times more houses sold in 2017 than DongCheng.
