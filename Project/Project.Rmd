...
The distribution for the condition of renovation shows that most listings have the highest score of 4 in terms of the condition of renovation for their listing. 
...
Let's divide construction time into 10 years interval. 
...
By using side by side bar graphs, we can see the relationship between the price of the listings compared to their corresponding districts and whether the owners have stayed in the listing for more than five years or less than five years. From the distribution, we can see that the most expensive listings are from the districts 1, 7, 8 and 10 and are usually stayed in for less than five years. Looking at the other end of the spectrum, we can see that the lower priced listings are found in districts 5 and 12 and are more likely to be stayed in for more than five years. This could be due to the affordability of the properties in the district. 
...
Looking at the distribution between these three relationships, we can see that as the year of construction increases, the availability of an elevator in the building becomes increasingly available and the price of the listing gradually increases as well.
...
From the distribution between price and construction time, we can see that the highest average price of the listings occured during the year 1973. 

```{r}
boxplot(price ~ constructionTime, data2017, main = "Distribution of Price and Construction Time", xlab = "Construction Time", ylab="Price", col = "light blue")
```
