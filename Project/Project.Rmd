...
ggplot(monthPrice,aes(x=month,y=meanPrice))+
  geom_col(fill = "lightblue")+ # geom_bar() not working?
  scale_x_discrete(limits = month.name)
...
As shown under the 3.1.4 Floor Range variable, Medium floor range is the most popular one and has the highest price per square meter/total price. There is no significant difference between other floor ranges.
