...
The year of construction of the listings that were transacted in 2017 ranges from the year 1950 to the year 2013.

The distribution skews to the left as the median of the year 1995 and mean of the year 1993 both lie to the left of the mode of the year 2000.
...
The distribution for the ladder ratio shows that most listings have 2 residents to one elevator per floor. This distribution skews heavily to the right.
...
Houses with more kitchens have higher mean prices. Let's compare how the number of kitchens affect price within each district.
...
From the distribution, we can see that for the districts FangShan, TongZhou, ChaoYang, DongCheng and XiCheng, the mean price for the listings where the previous owner has stayed in the property for less than five years is higher than if the previous owner has stayed in the property for more than five years. For the other districts including ShunYi, ChangPing, DaXing, ShiJingShan, FengTai and HaiDian, the mean price for the listings where the previous owner has stayed in the property for more than five years is higher than if the previous owner has stayed in the property for less than five years.
...
From the distribution, we can see that the districts ShunYi, MenTouGou, ChangPing, ShiJingShan, FengTai and DongCheng, the mean price for the listings are higher if there is no elevator in the building than if there was an elevator in the building. For the rest of the districts, DaXing, TongZhou, ChaoYang, HaiDian and XiCheng, the mean price for the listings are lower if there is no elevator in the building than if there was an elevator in the building.
