...
The graph for price is Diamond-shaped, unimodal, and skewed right. The average price per square meter is around 67,369 yuan and median is 62599, which are relative close. Approximately 2.5% of values are above 127,274 yuan. Approximately 2.5% of values are below 1194 yuan. The house that has the lowest value has 1194 yuan per square meter. It is located in ChaoYang(7) district and the mean of houses in ChaoYang has around 67,509 yuan per square meter. Besides, this house also has 3 bedrooms, 1 livingroom, 1 bathroom and kitchen but 0 followers. Thus, this value might be considered as an outlier.
